...
def readFile(fileName):
    file1 = open("D://Alberta//Thesis//scripts//Data//scenario1234//" + fileName, "r+")
    return file1.read()

def writeFile(data):
    file1 = open("D://Alberta//Thesis//scripts//Data//scenario1234//final_output.csv", "w+")
    return file1.write(data)

def main():
    wrk_csv = '\'latency_avg\',\'latency_stdev\',\'latency_max\',\'req_avg\',\'req_stdev\',\'req_max\', \'Total requests\'' \
              ',\'duration\',\'read\', \'reqests/sec\', \'transfers/sec\''
    for i in range(1, 31):
        print("****wrk output: \n\n")
        wrk_output = readFile("output-" + str(i) +".txt")
